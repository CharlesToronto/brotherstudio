...
const quickPrompts: QuickPrompt[] = [
  {
    ...
    question: "Quelles sont les dates prévues de livraison ?",
    gradientFrom: "#63c5ff",
    gradientTo: "#2f7df6",
  },
  {
    icon: <MapPin className="h-4 w-4" />,
    label: "Autour du projet",
    question: "Que trouve-t-on autour du projet Mésange ?",
    gradientFrom: "#8fe388",
    gradientTo: "#38b6a4",
  },
  {
    icon: <MapPin className="h-4 w-4" />,
    label: "Restaurants proches",
    question: "Quels restaurants sont à proximité du projet ?",
    gradientFrom: "#ffb36b",
    gradientTo: "#ff6c5f",
  },
  {
    icon: <MapPin className="h-4 w-4" />,
    label: "Accès au lac",
    question: "Combien de temps faut-il pour rejoindre le lac depuis le projet ?",
    gradientFrom: "#d398ff",
    gradientTo: "#f252c9",
  },
];
